...
csvFile = open('../../../CollectedData/NPP/NPPOfficialFollowerList.csv', 'a', encoding="utf-16")
...
for user in tweepy.Cursor(api.friends, screen_name="NPP_GH").items():
    try:
        with open('../../../CollectedData/NPP/NPPOfficialFollowerList.csv', 'a', encoding="utf-16") as csvFile:
            csvWriter.writerow([
