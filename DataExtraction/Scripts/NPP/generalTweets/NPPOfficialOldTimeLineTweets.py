...
csvFile = open('../../../CollectedData/NPP/NPPOfficialOldTimeLineTweets.csv', 'a', encoding="utf-16")  #
...
for tweet in tweepy.Cursor(api.user_timeline, screen_name='NPP_GH', tweet_mode="extended").items():
    try:
