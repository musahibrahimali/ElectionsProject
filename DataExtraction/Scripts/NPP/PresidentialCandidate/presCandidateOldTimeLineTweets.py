...
csvFile = open('../../../CollectedData/NPP/PresOldTimeLineTweets.csv', 'a', encoding="utf-16")
...
for tweet in tweepy.Cursor(api.user_timeline, screen_name='NAkufoAddo', tweet_mode="extended").items():
    try:
