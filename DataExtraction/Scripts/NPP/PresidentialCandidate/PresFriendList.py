...
csvFile = open('../../../CollectedData/NPP/PresFollowerList.csv', 'a', encoding="utf-16")
...
for user in tweepy.Cursor(api.friends, screen_name="NAkufoAddo").items():
    try:
        with open('../../../CollectedData/NPP/PresFollowerList.csv', 'a', encoding="utf-16") as csvFile:
            csvWriter.writerow([
