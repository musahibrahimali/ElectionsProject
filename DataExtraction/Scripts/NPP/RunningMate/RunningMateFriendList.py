...
csvFile = open('../../../CollectedData/NPP/RunningMateFollowerList.csv', 'a', encoding="utf-16")
...
for user in tweepy.Cursor(api.friends, screen_name="MBawumia").items():
    try:
        with open('../../../CollectedData/NPP/RunningMateFollowerList.csv', 'a', encoding="utf-16") as csvFile:
            csvWriter.writerow([
