...
csvFile = open('../../../CollectedData/NDC/NDCOfficialOldTimeLineTweets.csv', 'a', encoding="utf-16")
...
for tweet in tweepy.Cursor(api.user_timeline, screen_name='OfficialNDCGh', tweet_mode="extended").items():
    try:
